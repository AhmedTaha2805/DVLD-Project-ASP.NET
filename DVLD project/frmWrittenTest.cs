...
namespace DVLD_project
{
    public partial class frmWrittenTest : Form
    {
        ...
        private async void frmWrittenTest_Load(object sender, EventArgs e)
        {
            ...
            lbTrial.Text = (await _testAppointmentClientService.GetNumberOfTrials(LDLApp.LocalAppID, 2)).ToString();
            lbFees.Text = "20";
            if (_Retake)
            {
        ...
        private async void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else if (IsDone)
            {
                ...
                dto = await _testAppointmentClientService.AddTestAppointment(dto);
                MessageBox.Show($"Appointment Added Successfully with id = {dto.TestAppointmentId }", "Congratulations", MessageBoxButtons.OK);
            }
        }
    }
}
